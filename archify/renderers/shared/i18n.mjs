...
const MESSAGE_PAIRS = {
  ...
  'viewer.kind.software': ['Software module', '软件模块'],
  'viewer.kind.process': ['Process', '进程'],
  'viewer.kind.thread': ['Thread', '线程'],
  'viewer.kind.task': ['Task', '任务'],
  'viewer.kind.isr': ['ISR', '中断服务'],
  'viewer.kind.hardware': ['Hardware', '硬件'],
  'viewer.kind.buffer': ['Buffer', '缓冲区'],
  'viewer.kind.memory': ['Memory', '存储介质'],
  'viewer.kind.bus': ['Hardware bus', '硬件总线'],

  'embedded.context.linux-user': ['Linux user', 'Linux 用户态'],
  'embedded.context.linux-kernel': ['Linux kernel', 'Linux 内核态'],
  'embedded.context.linux-irq': ['Linux IRQ', 'Linux 中断上下文'],
  'embedded.context.rtos-task': ['RTOS task', 'RTOS 任务'],
  'embedded.context.rtos-isr': ['RTOS ISR', 'RTOS 中断'],
  'embedded.context.bare-main': ['Bare-metal main', '裸机主循环'],
  'embedded.context.bare-isr': ['Bare-metal ISR', '裸机中断'],
  ...
  'embedded.mechanism.device-binding': ['Device binding', '设备绑定'],
  'embedded.mechanism.ipc': ['IPC', 'IPC'],
  'embedded.mechanism.task-sync': ['Task sync', '任务同步'],
  'embedded.mechanism.irq': ['IRQ', 'IRQ'],
  'embedded.mechanism.dma': ['DMA', 'DMA'],
  'embedded.mechanism.shared-memory': ['Shared memory', '共享内存'],
  'embedded.mechanism.bus': ['Hardware bus', '硬件总线'],
  'embedded.mechanism.firmware-load': ['Firmware load', '固件加载'],
  'embedded.mechanism.lifecycle-control': ['Lifecycle control', '生命周期控制'],
  'embedded.mechanism.data-transfer': ['Data transfer', '数据传输'],
  'embedded.mechanism.notification': ['Notification', '通知'],
